...
def generate_profile(product: ProductMaster, layout: dict | None = None) -> pd.DataFrame:
...
def generate_full_profile(product: ProductMaster, layout: dict | None = None) -> pd.DataFrame:
